...
# Configure page
st.set_page_config(
    page_title="Personalized Doc Assist",
    page_icon="📄",
    layout="wide"
)
...
if not HUGGINGFACE_TOKEN or not GOOGLE_API_KEY:
    st.error("Please set API keys in .env file")
    st.stop()
...
local_css("style_personalized_doc_assist.css")
...
st.markdown("<h1 style='text-align: center;color:#e61542;'>Personalized Doc Assist</h1>", unsafe_allow_html=True)
